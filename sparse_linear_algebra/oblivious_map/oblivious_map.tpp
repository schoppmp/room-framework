...
void oblivious_map<K, V>::run_server(
    ...
    const oblivious_map<K, V>::value_range defaults, bool shared_output,
    mpc_utils::Benchmarker* benchmarker) {
